...
+---------------+----------------------------------------------+
| combo-ip      | IPv4 or IPv6 address in network byte order   |
+---------------+----------------------------------------------+
...
+---------------+----------------------------------------------+
| uint8         | Unsigned 1 octet long integer                |
+---------------+----------------------------------------------+
| uint16        | Unsigned 2 octet long integer                |
+---------------+----------------------------------------------+
| uint32        | Unsigned 4 octet long integer                |
+---------------+----------------------------------------------+
| uint64        | Unsigned 8 octet long integer                |
+---------------+----------------------------------------------+
| int64         | Signed 8 octet long integer                  |
+---------------+----------------------------------------------+
